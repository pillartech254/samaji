...
(function () {
  ...
  function studentReportHTML(opts){
    ...
    return '<div class="rc-card">'
      ...
      +   head + bio + grid + remarks + signatures + dates
      +   '<div class="rc-foot2">Generated by Samaji School System · '+esc(genDate)+'</div>'
      + '</div>'
      + '</div>';
  }
  ...
  var RC_CSS = ''
    ...
    +'table.rc-bio2{width:100%;border-collapse:collapse;font-size:12px;margin-bottom:12px;}'
